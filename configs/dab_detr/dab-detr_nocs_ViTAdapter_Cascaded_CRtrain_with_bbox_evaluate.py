...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='/root/commonfile/fxf/nocs/',
        ann_file='annotations/nocs/train_real.json',
...
log_level = 'INFO'
load_from = 'work_dirs/dab-detr_nocs_ViTAdapter_Cascaded_CRtrain/epoch_6.pth'
resume = True
model = dict(
    type='DABDETRPhoCal',
    num_queries=300,
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_bbox=dict(type='L1Loss', loss_weight=4.0),
...
launcher = 'pytorch'
work_dir = 'work_dirs/dab-detr_nocs_ViTAdapter_Cascaded_CRtrain_resume_from_VCCRepoch6'
