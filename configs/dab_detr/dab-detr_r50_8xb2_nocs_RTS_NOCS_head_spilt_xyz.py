...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_R=dict(type='SmoothL1Loss', loss_weight=6.0), #放大三者的loss
        loss_T_xy=dict(type='L1Loss', loss_weight=8.0),
        loss_T_z=dict(type='L1Loss', loss_weight=8.0),
        loss_size=dict(type='MSELoss', loss_weight=2.0),
        ),
