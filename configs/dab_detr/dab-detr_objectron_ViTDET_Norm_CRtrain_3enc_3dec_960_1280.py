...
dataset_type = 'CocoDatasetOmni3D'
data_root = '/root/userfolder/github/omni3d/datasets/' #2080
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/omni3d/Objectron_train_nocs.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/omni3d/Objectron_test_nocs.json',
        data_prefix=dict(img=''),
        test_mode=True,
...
val_evaluator = dict(
    type='CocoMetricNOCS', # 修改eval nocs中的类别
    ann_file=data_root + 'annotations/omni3d/Objectron_test_nocs.json',
    metric=['pose','bbox'],
    #metric='pose',
