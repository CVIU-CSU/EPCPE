...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/omni3d/omni_all_train_nocs.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/omni3d/omni_all_test_nocs.json',
        data_prefix=dict(img=''),
        test_mode=True,
...
val_evaluator = dict(
    ...
    ann_file=data_root + 'annotations/omni3d/omni_all_test_nocs.json',
    metric=['pose'],
    #metric='pose',
