...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/sunrgbd/train_cppf.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/sunrgbd/test_cppf.json',
        data_prefix=dict(img=''),
        test_mode=True,
...
val_evaluator = dict(
    ...
    ann_file=data_root + 'annotations/sunrgbd/test_cppf.json',
    metric=['pose','bbox'],
    synset_names=['BG', 'bed','table','sofa','chair','bookshelf','bathtub'],
    #metric='pose',
