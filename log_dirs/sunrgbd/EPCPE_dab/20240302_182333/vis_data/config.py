...
log_level = 'INFO'
load_from = 'work_dirs/dab-detr_sunrgbd_ViTDINO_3enc_3dec/epoch_64.pth'
resume = True
model = dict(
    type='DABDETRPhoCal',
    num_queries=100,
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        custom_keys=dict(backbone=dict(lr_mult=0.0, decay_mult=1.0))))
max_epochs = 200
...
launcher = 'none'
work_dir = './work_dirs/dab-detr_sunrgbd_ViTDINO_3enc_3dec'
