...
log_level = 'INFO'
load_from = 'work_dirs/detr_nocs_r50_Norm_CRtrain_3enc_3dec_rot_nore/epoch_11.pth'
resume = True
model = dict(
    type='DETR',
    num_queries=100,
    ...
    bbox_head=dict(
        ...
        loss_R=dict(type='ROTLoss', loss_weight=5.0),
...
launcher = 'pytorch'
work_dir = './work_dirs/detr_nocs_r50_Norm_CRtrain_3enc_3dec_rot_nore'
