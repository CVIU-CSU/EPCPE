...
log_level = 'INFO'
load_from = 'work_dirs/dab-detr_nocs_ViTDINO_Norm_CRtrain_3enc_3dec_mse/epoch_30.pth'
resume = True
model = dict(
    type='DABDETRPhoCal',
    num_queries=100,
    ...
    bbox_head=dict(
        ...
        loss_R=dict(type='MSELoss', loss_weight=5.0),
        loss_RE=dict(type='MSELoss', loss_weight=3.0),
...
launcher = 'pytorch'
work_dir = './work_dirs/dab-detr_nocs_ViTDINO_Norm_CRtrain_3enc_3dec_mse'
