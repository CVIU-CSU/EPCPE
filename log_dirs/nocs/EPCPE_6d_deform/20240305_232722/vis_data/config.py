...
log_level = 'INFO'
load_from = 'work_dirs/deformable-detr_nocs_ViTDINO_Norm_CRtrain_3enc_3dec_multi_scale/epoch_24.pth'
resume = True
model = dict(
    type='DeformableDETR',
    num_queries=100,
...
max_epochs = 48
train_cfg = dict(type='EpochBasedTrainLoop', max_epochs=48, val_interval=16)
...
launcher = 'pytorch'
work_dir = './work_dirs/deformable-detr_nocs_ViTDINO_Norm_CRtrain_3enc_3dec_multi_scale'
