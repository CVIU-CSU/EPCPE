...
log_level = 'INFO'
load_from = 'work_dirs/dab-detr_nocs_ViTDET_Norm_CRtrain_3enc_3dec_sam_bgr/epoch_26.pth'
resume = True
model = dict(
    type='DABDETRPhoCal',
    num_queries=100,
...
launcher = 'pytorch'
work_dir = './work_dirs/dab-detr_nocs_ViTDET_Norm_CRtrain_3enc_3dec_sam_bgr'
