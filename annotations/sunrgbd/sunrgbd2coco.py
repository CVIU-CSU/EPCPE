...
categories = [ #只用超类作为监督信息
    ...
    {'supercategory': 'toilet', 'id': 4, 'name': 'toilet'},
    {'supercategory': 'desk', 'id': 5, 'name': 'desk'},
    {'supercategory': 'dresser', 'id': 6, 'name': 'dresser'},
    {'supercategory': 'night_stand', 'id': 7, 'name': 'night_stand'},
    {'supercategory': 'bookshelf', 'id': 8, 'name': 'bookshelf'},
    {'supercategory': 'bathtub', 'id': 9, 'name': 'bathtub'},
]

cat_id_list=['bed','table','sofa','chair','toilet','desk','dresser','night_stand','bookshelf','bathtub'] # 用于查找新的cat_id
