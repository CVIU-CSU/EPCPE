...
class DETRHeadCascaded(DETRHead):
    ...
    def __init__(
            ...
            **kwargs) -> None:
        super(DETRHeadCascaded,self).__init__(**kwargs)
    ...
    def _init_layers(self) -> None:
        ...
        # trs branch
        self.fc_reg_T = MLP(self.embed_dims+4, self.embed_dims, 3, 3) #3X1 1 Mat
        # reg branch
        self.fc_reg = MLP(self.embed_dims, self.embed_dims, 4, 3)
        # size branch
        self.fc_reg_size = MLP(self.embed_dims+4, self.embed_dims, 3, 3) #预测3d bbox的size
    ...
    def forward(self, hidden_states: Tensor) -> Tuple[Tensor, Tensor ,Tensor,Tensor,Tensor]:
        ...
        hidden_states_bbox=torch.cat([hidden_states,layers_bbox_preds],dim=-1)
    ...
    def _get_targets_single(self, cls_score: Tensor,bbox_pred: Tensor, rot_pred: Tensor, pos_pred: Tensor, size_pred: Tensor,
        ...
        pred_instances.rots=rot_pred
        pred_instances.poses=pos_pred
        pred_instances.sizes=size_pred
