...
class DeformableDETRHeadNOCSNormNORE(DETRHead):
    ...
    def __init__(self,
                 *args,
                 ...
                 loss_R:ConfigType = dict(type='SmoothLoss', loss_weight=1.0),
        ...
        super(DeformableDETRHeadNOCSNormNORE,self).__init__(*args, **kwargs)
