...
class DABDETRHeadNOCS(ConditionalDETRHead): 
    ...
    def __init__(
            ...
            **kwargs) -> None:
        super(DABDETRHeadNOCS,self).__init__(**kwargs)
    ...
    def loss_by_feat( #以下内容来自DETRHead
        ...
        losses_cls, losses_bbox, losses_iou, losses_R, losses_T, losses_size, losses_RE = multi_apply(
        ...
        num_dec_layer = 0
        for loss_cls_i,loss_bbox_i,loss_iou_i, loss_R_i, loss_T_i, loss_size_i, loss_RE_i in \
                zip(losses_cls[:-1], losses_bbox[:-1], losses_iou[:-1], losses_R[:-1], losses_T[:-1], losses_size[:-1], losses_RE[:-1]):
    ...
    def loss_by_feat_single(self, cls_scores: Tensor, bbox_preds: Tensor, bbox_R_preds: Tensor, bbox_T_preds: Tensor,
        ...
        return loss_cls,loss_bbox, loss_iou, loss_R, loss_T, loss_size ,loss_RE 
    ...
    def get_targets(self, cls_scores_list: List[Tensor],
        ...
        return (labels_list, label_weights_list,bbox_targets_list,bbox_weights_list,  bbox_R_targets_list, bbox_R_weights_list, 
                bbox_T_targets_list, bbox_T_weights_list, bbox_size_targets_list, bbox_size_weights_list, 
