...
class DABDETRHeadNOCSNormROT(ConditionalDETRHead): 
    ...
    def __init__(
            ...
            #loss_rot:ConfigType = dict(type='ROTLoss', loss_weight=1.0),
            ...
            **kwargs) -> None:
        super(DABDETRHeadNOCSNormROT,self).__init__(**kwargs)
