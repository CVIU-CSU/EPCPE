...
class DeformableDETRHeadNOCSNormROTNORE(DETRHead):
    ...
    def __init__(self,
        ...
        super(DeformableDETRHeadNOCSNormROTNORE,self).__init__(*args, **kwargs)
    ...
    def _init_layers(self) -> None:
        ...
        # rot branch
        fc_reg_R = MLP(self.embed_dims, self.embed_dims, 6, 3) #先输出6维结果
        # trs branch
    ...
    def forward(self, hidden_states: Tensor,
        ...
        for layer_id in range(hidden_states.shape[0]):
            ...
            outputs_R_tmp = self.rot_branches[layer_id](hidden_state)
            outputs_R = self.rotation_6d_to_matrix(outputs_R_tmp)
