...
class DETRHeadNOCSNormROTNORE(DETRHead): 
    ...
    def __init__(
            ...
            **kwargs) -> None:
        super(DETRHeadNOCSNormROTNORE,self).__init__(**kwargs)
    ...
    def _init_layers(self) -> None:
        ...
        # rot branch
        self.fc_reg_R = MLP(self.embed_dims, self.embed_dims, 6, 3) #先输出6维结果 转成9维
        # trs branch
    ...
    def forward(self, hidden_states: Tensor) -> Tuple[Tensor, Tensor ,Tensor,Tensor,Tensor]:
        """"Forward function.
        ...
        layers_bbox_preds_R_tmp = self.fc_reg_R(hidden_states)
        ...
        layers_bbox_preds = self.fc_reg(hidden_states).sigmoid()
    ...
    def _predict_by_feat_single(self,
        ...
        if self.loss_cls.use_sigmoid:
            ...
            bbox_pred_R = bbox_pred_R[bbox_index] * bbox_pred_scale[bbox_index] #预测的rotation需要乘以scale
            ...
            bbox_pred = bbox_pred[bbox_index]
            bbox_pred_R_norm = bbox_pred_R[bbox_index]
            bbox_pred_R = bbox_pred_R[bbox_index] * bbox_pred_scale[bbox_index]
            bbox_pred_T = bbox_pred_T[bbox_index]
            bbox_pred_size = bbox_pred_size[bbox_index]
