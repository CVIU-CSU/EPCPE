...
class DeformableDETRHeadNOCS(DETRHead):
    ...
    def __init__(self,
        ...
        super(DeformableDETRHeadNOCS,self).__init__(*args, **kwargs)
    ...
    def forward(self, hidden_states: Tensor,
        ...
        return all_layers_outputs_classes, all_layers_outputs_coords,\
                all_layers_outputs_R,all_layers_outputs_T,all_layers_outputs_size
    ...
    # def predict_by_feat(self, #origin deformable detr code
    #                     all_layers_cls_scores: Tensor,
    #                     all_layers_bbox_preds: Tensor,
    #                     batch_img_metas: List[Dict],
