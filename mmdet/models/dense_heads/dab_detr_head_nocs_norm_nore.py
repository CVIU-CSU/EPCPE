...
class DABDETRHeadNOCSNormNORE(ConditionalDETRHead): 
    ...
    def __init__(
            ...
            **kwargs) -> None:
        super(DABDETRHeadNOCSNormNORE,self).__init__(**kwargs)
    ...
    def _freeze_3d(self): #冻结3d相关的参数
        for param in self.fc_reg_R.parameters():
            param.requires_grad = False
        for param in self.fc_reg_T.parameters():
            param.requires_grad = False
        for param in self.fc_reg_size.parameters():
            param.requires_grad = False
        for param in self.fc_reg_scale.parameters():
            param.requires_grad = False

    def _freeze_2d(self): #冻结3d相关的参数
