...
from ..layers import (DetrTransformerDecoder, DetrTransformerEncoder,DetrTwoWayTransformerDecoder,
                      SinePositionalEncoding)
from .base_detr import DetectionTransformer


@MODELS.register_module()
class SAMDETR(DetectionTransformer):
    ...
    def _init_layers(self) -> None:
        ...
        self.decoder = DetrTwoWayTransformerDecoder(**self.decoder)
