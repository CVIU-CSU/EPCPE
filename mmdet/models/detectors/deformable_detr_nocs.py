...
class DeformableDETRNOCS(DetectionTransformer):
    ...
    def pre_decoder(self, memory: Tensor, memory_mask: Tensor,
        ...
        if self.as_two_stage:
            ...
            enc_outputs_pose['enc_outputs_rot'] = enc_outputs_rot
            enc_outputs_pose['enc_outputs_trans'] = enc_outputs_trans
            enc_outputs_pose['enc_outputs_size'] = enc_outputs_size
            enc_outputs_pose['enc_outputs_scale'] = enc_outputs_scale
        ...
        head_inputs_dict = dict(
            ...
            enc_outputs_pose=enc_outputs_pose) if self.training else dict()
