...
class SAMAdapterTransformerDecoder(BaseModule):
    """Decoder of DETR.
        ...
        if self.pretrained is None:
            ...
            for key,value in state_dict.items():
                if 'mask_decoder' in key:
                    ...
                    value.requires_grad = False #冻结原有参数
    ...
    def _init_layers(self) -> None:
        ...
        self.layers = ModuleList([
            SAMAdapterTransformerDecoderLayer(**self.layer_cfg,is_last=(i==self.num_layers-1))
...
class SAMAdapterTransformerDecoderLayer(BaseModule):
    ...
    def _init_layers(self) -> None:
        ...
        self.s_adapter_1 = Adapter(self.embed_dims)
        self.s_adapter_2 = Adapter(self.embed_dims)
        self.s_adapter_3 = Adapter(self.embed_dims)
    ...
    def forward(self,
        ...
        query = query+self.s_adapter_1(query) #adapter
        ...
        query = query+self.s_adapter_2(query)
