...
class DetrTwoWayTransformerDecoder(BaseModule):
    """Decoder of DETR.
    ...
    def _init_layers(self) -> None:
        ...
        self.layers = ModuleList([
            DetrTwoWayTransformerDecoderLayer(**self.layer_cfg,is_last=(i==self.num_layers-1))
...
class DetrTwoWayTransformerDecoderLayer(BaseModule):
